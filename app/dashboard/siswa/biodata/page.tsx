      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl border border-slate-200 shadow-sm overflow-hidden space-y-6 p-6 sm:p-8">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
              <span className="text-xs text-slate-400 font-semibold block">Birth Date</span>
              <span className="font-bold text-slate-700">{formatDate(sp?.dateOfBirth)}</span>
            </div>
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
              <span className="text-xs text-slate-400 font-semibold block">Gender</span>
              <span className="font-bold text-slate-700">{sp?.gender || "-"}</span>
            </div>
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
              <span className="text-xs text-slate-400 font-semibold block">Religion</span>
              <span className="font-bold text-slate-700">{sp?.religion || "-"}</span>
            </div>
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
              <span className="text-xs text-slate-400 font-semibold block">School of Origin </span>
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 sm:col-span-2">
              <span className="text-xs text-slate-400 font-semibold block">Join Date</span>
              <span className="font-bold text-slate-700">{formatDate(sp?.joinDate)}</span>
            </div>
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100 sm:col-span-2">
              <span className="text-xs text-slate-400 font-semibold block">Address</span>
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-amber-50/50 p-3.5 rounded-xl border border-amber-100">
              <span className="text-xs text-amber-700 font-semibold block">Father</span>
              <span className="font-bold text-slate-800">{sp?.fatherName || "-"}</span>
              {sp?.fatherOccupation && (
                <span className="text-xs text-slate-500 block mt-0.5">Occupation: {sp.fatherOccupation}</span>
              )}
            </div>
            <div className="bg-amber-50/50 p-3.5 rounded-xl border border-amber-100">
              <span className="text-xs text-amber-700 font-semibold block">Mother</span>
              <span className="font-bold text-slate-800">{sp?.motherName || "-"}</span>
              {sp?.motherOccupation && (
                <span className="text-xs text-slate-500 block mt-0.5">Occupation: {sp.motherOccupation}</span>
              )}
            </div>
            <div className="bg-amber-50/50 p-3.5 rounded-xl border border-amber-100 sm:col-span-2">
              <span className="text-xs text-amber-700 font-semibold block">Parent's Contact Info</span>
        ...
        {sp?.guardianName && (
          <div className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                <span className="text-xs text-slate-400 font-semibold block">Guradian</span>
                <span className="font-bold text-slate-700">{sp.guardianName}</span>
                {sp.guardianOccupation && (
                  <span className="text-xs text-slate-500 block mt-0.5">Occupation: {sp.guardianOccupation}</span>
                )}
              </div>
              <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-100">
                <span className="text-xs text-slate-400 font-semibold block">Guardian's Contact Info</span>
