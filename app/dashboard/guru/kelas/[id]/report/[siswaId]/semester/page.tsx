    ...
    <div className="p-4 sm:p-8 max-w-4xl mx-auto box-border w-full animate-in fade-in duration-300">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Siswa: <span className="font-semibold text-slate-800">{siswa.user.name}</span> ({siswa.user.username})</p>
        </div>
      </div>
        ...
        <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-xs border border-slate-200">
          <div className="border-b border-slate-100 pb-4 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Isi nilai Mid dan/atau Final. Kosongkan jika ujian belum dilaksanakan.</p>
            </div>
...
>
  ...
  <option value="Requires additional guidance and practice">Requires additional guidance and practice</option>
        ...
        <div className="bg-white p-5 sm:p-6 rounded-2xl shadow-xs border border-slate-200">
          <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Comments / Feedback (Untuk Halaman 2 Rapor)</label>
          <textarea 
            name="comments" 
            rows={4}
        ...
        >
          <span>💾</span> Simpan Assessment Semester
        </button>
      </form>
    </div>
  );
